...
urlpatterns = [
    ...
    path('thesis_finder_profile_delete/', views.thesis_finder_profile_delete_view, name='thesis_finder_profile_delete'),
    path('thesis_finder_group/', views.thesis_finder_group_view, name='thesis_finder_group'),
]
