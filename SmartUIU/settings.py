"""
Django settings for SmartUIU project.
...
SECRET_KEY = 'django-insecure-h&7i*&a%snrljk#skcz$$spw45gobs-kyhfu_84^n@44l(sk-2'
...
WSGI_APPLICATION = 'SmartUIU.wsgi.application'
